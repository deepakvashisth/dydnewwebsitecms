      ...
      <FormGroup>
        <InputGroup className="input-group-seamless input_group_brd_wid">
          <Input
            ...
            id="searchmain"
          />
          <button className="mobbtnsearch">Search</button>
          <div className="input-group-append searchright">
            <InputGroupText>
              <img
                className="mainsearchicon searchdefault"
                src={`/assets/images/avatars/searchmaincol.svg`}
                alt="Search Icon"
              />
            </InputGroupText>
          </div>
          <ul style={{ zIndex: 9 }} className="search_history_state">
            <li>
              <button>
                <img src={`/assets/images/avatars/crosstag.svg`} alt="Clear Search" />
              </button>
            </li>
            ...
            <li>
              <button>
                <img
                  src={`/assets/images/avatars/searccirclemain.svg`}
