            ...
            <UncontrolledDropdown tag="span" className="avail_dropdown">
                ...
                <DropdownMenu className="avail_droplist">
                    <ul className="availiable_stat">
                        ...
                        <li>
                            <img
                                src={`${config.AMAZON_ASSETS_URL}avatars/checktag.svg`}
                                alt=""
                            />
                        </li>
                    </ul>
                    ...
                    >
                        <li>
                            <span className="set_offline">
                                <img
                                    src={`${config.AMAZON_ASSETS_URL}avatars/offlineaway.svg`}
                                    alt=""
                                />
                            </span>
                        </li>
                    ...
                    <ul className="avail_otheroption">
                        <li>
                            <Link
                                to="/availability"
                                onClick={() => {
                                    const dropdown = document.querySelector(".avail_droplist.dropdown-menu");
                            ...
                            >
                                <img
                                    src={`${config.AMAZON_ASSETS_URL}avatars/availstat.svg`}
